...
void HMC5883L_I2C_Init()
{
	...
	GPIO_PinAFConfig(HMC5883L_I2C_Port, GPIO_PinSource10, GPIO_AF_I2C2); // TODO Add or remove defines
  	GPIO_PinAFConfig(HMC5883L_I2C_Port, GPIO_PinSource11, GPIO_AF_I2C2);
