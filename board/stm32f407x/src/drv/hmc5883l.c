...
void HMC5883L_Initialize()
{
	...
	i2c2_byte_write(I2C2_DEFAULT_ADDRESS, &tmp, HMC5883L_RA_CONFIG_A);
...
{
	uint8_t tmp[3] = { 0 };
	i2c2_buffer_read(I2C2_DEFAULT_ADDRESS, tmp, HMC5883L_RA_ID_A, 3);
...
{
	uint8_t tmp;
	HMC5883L_ReadBits(I2C2_DEFAULT_ADDRESS, HMC5883L_RA_CONFIG_A, HMC5883L_CRA_AVERAGE_BIT, HMC5883L_CRA_AVERAGE_LENGTH, &tmp);
	return tmp;
}
...
{
	HMC5883L_WriteBits(I2C2_DEFAULT_ADDRESS, HMC5883L_RA_CONFIG_A, HMC5883L_CRA_AVERAGE_BIT, HMC5883L_CRA_AVERAGE_LENGTH, averaging);
}
...
{
	uint8_t tmp;
	HMC5883L_ReadBits(I2C2_DEFAULT_ADDRESS, HMC5883L_RA_CONFIG_A, HMC5883L_CRA_RATE_BIT, HMC5883L_CRA_RATE_LENGTH, &tmp);
	return tmp;
}
...
{
	HMC5883L_WriteBits(I2C2_DEFAULT_ADDRESS, HMC5883L_RA_CONFIG_A, HMC5883L_CRA_RATE_BIT, HMC5883L_CRA_RATE_LENGTH, rate);
}
...
{
	uint8_t tmp;
	HMC5883L_ReadBits(I2C2_DEFAULT_ADDRESS, HMC5883L_RA_CONFIG_A, HMC5883L_CRA_BIAS_BIT, HMC5883L_CRA_BIAS_LENGTH, &tmp);
	return tmp;
}
...
{
	HMC5883L_WriteBits(I2C2_DEFAULT_ADDRESS, HMC5883L_RA_CONFIG_A, HMC5883L_CRA_BIAS_BIT, HMC5883L_CRA_BIAS_LENGTH, bias);
}
...
{
	uint8_t tmp;
	HMC5883L_ReadBits(I2C2_DEFAULT_ADDRESS, HMC5883L_RA_CONFIG_B, HMC5883L_CRB_GAIN_BIT, HMC5883L_CRB_GAIN_LENGTH, &tmp);
	return tmp;
}
...
void HMC5883L_SetGain(uint8_t gain)
{
	...
	i2c2_byte_write(I2C2_DEFAULT_ADDRESS, &tmp, HMC5883L_RA_CONFIG_B);
}
...
{
	uint8_t tmp;
	HMC5883L_ReadBits(I2C2_DEFAULT_ADDRESS, HMC5883L_RA_MODE, HMC5883L_MODEREG_BIT, HMC5883L_MODEREG_LENGTH, &tmp);
	return tmp;
}
...
void HMC5883L_SetMode(uint8_t newMode)
{
	...
	i2c2_byte_write(I2C2_DEFAULT_ADDRESS, &tmp, HMC5883L_RA_MODE);
...
{
	uint8_t tmpbuff[6] = { 0 };
	i2c2_buffer_read(I2C2_DEFAULT_ADDRESS, tmpbuff, HMC5883L_RA_DATAX_H, 6);
...
{
	uint8_t tmp;
	HMC5883L_ReadBit(I2C2_DEFAULT_ADDRESS, HMC5883L_RA_STATUS, HMC5883L_STATUS_LOCK_BIT, &tmp);
	return tmp == 0x01 ? 1 : 0;
}
...
{
	uint8_t tmp;
	HMC5883L_ReadBit(I2C2_DEFAULT_ADDRESS, HMC5883L_RA_STATUS, HMC5883L_STATUS_READY_BIT, &tmp);
	return tmp == 0x01 ? 1 : 0;
}
...
{
	uint8_t tmp;
	i2c2_buffer_read(slaveAddr, &tmp, regAddr, 1);
	uint8_t mask = ((1 << length) - 1) << (bitStart - length + 1);
	data <<= (bitStart - length + 1); // shift data into correct position
	data &= mask; // zero all non-important bits in data
	tmp &= ~(mask); // zero all important bits in existing byte
	tmp |= data; // combine data with existing byte
	i2c2_byte_write(slaveAddr, &tmp, regAddr);
}
